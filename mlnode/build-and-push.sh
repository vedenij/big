...
# Build and push Big MLNode image to GitHub Container Registry
# Repository: https://github.com/vedenij/big.git

VERSION=${1:-"3.0.11"}
GITHUB_USER="vedenij"
IMAGE_NAME="bigmlnode"
FULL_IMAGE="ghcr.io/${GITHUB_USER}/${IMAGE_NAME}:${VERSION}"

echo "============================================"
echo "Building Big MLNode image (Delegation Server)"
